...
def vol_seg(volpath,
    ...
    ** kwargs are any named arguments for vol(...),
        except verbose, data_proc_fn, exts, nb_labels_reshape and name
    ...
    # vol_files = [f.replace('norm', 'aseg') for f in _get_file_list(volpath, exts)]
...
def vol_cat(volpaths,  # expect two folders in here
    ...
    kwargs: # named arguments for vol(...), except verbose, data_proc_fn, exts,
